  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      {isLoading ? (
        ...
        <p className="text-muted-foreground text-center py-4">No collection routes found.</p>
      ) : (
        <div className="space-y-3">
          {collections.map((c: any) => (
            <div key={c.id || c._id} className="bg-card rounded-2xl p-5 shadow-card flex items-center gap-4">
